%ver02 does not bother outputting area ratios, to avoid confusion



function [streamlineVelocities,streamlinePressures,streamlineTemperatures,streamlineDensities,...
    streamlineMachNumbers,streamlineSpeedsOfSound]...
    = streamlineSolverVer02(streamlineAreas,streamlineMassFlowRate)
...
for i = 1:length(streamlineAreas)
    ...
    while residual > 1e-6
        ...
        residual = abs( ( iterated_solutions(2,n) - iterated_solutions(2,n-1) )/iterated_solutions(2,n-1) );
