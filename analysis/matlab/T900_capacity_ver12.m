...
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,2)./0.000485213856060506 - 1), 'k.')
hold on
%plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,3)./0.000485213856060506 - 1), 'kx')
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,4)./0.000485213856060506 - 1), 'r.')
%plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,5)./0.000485213856060506 - 1), 'kh')
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,6)./0.000485213856060506 - 1), 'g.')
%plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,7)./0.000485213856060506 - 1), 'ko')
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,8)./0.000485213856060506 - 1), 'b.')
%plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,9)./0.000485213856060506 - 1), 'kp')
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,10)./0.000485213856060506 - 1), 'c.')
%plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,11)./0.000485213856060506 - 1), 'kd')
plot(T900_TE_capacities_2D(:,1), 100*(T900_TE_capacities_2D(:,12)./0.000485213856060506 - 1), 'm.')

plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,2)./0.000485213856060506 - 1), 'k-')
%plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,3)./0.000485213856060506 - 1), 'k-.')
plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,4)./0.000485213856060506 - 1), 'r-')
%plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,5)./0.000485213856060506 - 1), 'k-.')
plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,6)./0.000485213856060506 - 1), 'g-')
%plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,7)./0.000485213856060506 - 1), 'k-.')
plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,8)./0.000485213856060506 - 1), 'b-')
%plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,9)./0.000485213856060506 - 1), 'k-.')
plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,10)./0.000485213856060506 - 1), 'c-')
%plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,11)./0.000485213856060506 - 1), 'k-.')
plot(T900_TE_capacities_2D_oversampled(:,1), 100*(T900_TE_capacities_2D_oversampled(:,12)./0.000485213856060506 - 1), 'm-')
...
plot(T900_novel_capacities_2D(:,1), 100*(T900_novel_capacities_2D(:,2)./0.000493844923293628 - 1), 'k.')
hold on
plot(T900_novel_capacities_2D(:,1), 100*(T900_novel_capacities_2D(:,10)./0.000493844923293628 - 1), 'r.')
plot(T900_novel_capacities_2D(:,1), 100*(T900_novel_capacities_2D(:,9)./0.000493844923293628 - 1), 'g.')
plot(T900_novel_capacities_2D(:,1), 100*(T900_novel_capacities_2D(:,8)./0.000493844923293628 - 1), 'b.')
plot(T900_novel_capacities_2D(:,1), 100*(T900_novel_capacities_2D(:,6)./0.000493844923293628 - 1), 'c.')

%plot(T900_capacities_2D_oversampled(:,1), 100*(T900_capacities_2D_oversampled(:,2)./T900_capacities_2D_design(1,2) - 1), 'k-')
plot(T900_novel_capacities_2D_oversampled(:,1), 100*(T900_novel_capacities_2D_oversampled(:,2)./0.000493844923293628 - 1), 'k-')
plot(T900_novel_capacities_2D_oversampled(:,1), 100*(T900_novel_capacities_2D_oversampled(:,10)./0.000493844923293628 - 1), 'r-')
plot(T900_novel_capacities_2D_oversampled(:,1), 100*(T900_novel_capacities_2D_oversampled(:,9)./0.000493844923293628 - 1), 'g-')
plot(T900_novel_capacities_2D_oversampled(:,1), 100*(T900_novel_capacities_2D_oversampled(:,8)./0.000493844923293628 - 1), 'b-')
plot(T900_novel_capacities_2D_oversampled(:,1), 100*(T900_novel_capacities_2D_oversampled(:,6)./0.000493844923293628 - 1), 'c-')
