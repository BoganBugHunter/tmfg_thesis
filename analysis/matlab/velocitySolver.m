function [streamlineVelocities,streamlinePressures,streamlineTemperatures,streamlineDensities,streamlineMachNumbers,streamlineSpeedsOfSound,streamlineAreaRatios] = velocitySolver(streamlineAreas,streamlineMassFlowRate)
