...
\section{Effects of trailing edge shape uncertainty}
...
\begin{figure}[H]
	...
	\caption{Loss delta as a function of capacity delta at $PR=1.79$}
...
This section considers the location of the pressure side cutback necessary to make cooling holes invulnerable to blockage.  Here a partially eroded suction side trailing-edge is used (50\% eroded) to be representative of the full lifetime of the component and the design choice position for the cutback is progressively moved upstream on the pressure side. In each case the measures outlined above are reported. 
